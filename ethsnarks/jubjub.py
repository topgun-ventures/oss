...
class AbstractCurveOps(object):
    ...
    def all_loworder_points(cls):
        ...
        return [
            ...
            Point(
                FQ(
                    17545522957889784193459637215142187266023652151580582754000402781682644312291
                ),
                FQ(
                    4826523245007015323400664741523384119579596407052839571721035538011798951543
                ),
            ...
            Point(
                FQ(
                    18930368022820495955728484915491405972470733850014661777449844430438130630919
                ),
                FQ(0),
            ),
        ]
